...
| `AppShell` | Authenticated frame: header, Atlas/Data Governance nav, mono identity chip, theme toggle, sign out. Data Governance owns its whole subtree for the active highlight. |
